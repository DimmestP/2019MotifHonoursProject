...
model_data_2 <- add_column(model_data, 
...
```{R Plot Linear Model}
ggplot(data = model_data_2, aes(x = pred_hlife, y = hlife)) + 
  geom_point() + 
  geom_smooth() +
...
1. How to enable values (median?) to show up on the boxplot

2. Why is the range of predicted values so small? Is it because anything lower or higher isn't explained by our lm?
